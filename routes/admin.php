...
use App\Livewire\Admin\ContactPageSettings;
use App\Livewire\Admin\ThankYouPageSettings;
...
use App\Livewire\Admin\CookieConsentSettings;
...
Route::get('/contact-page', ContactPageSettings::class)->name('contact-page');
Route::get('/thank-you-page', ThankYouPageSettings::class)->name('thank-you-page');
...
Route::get('/cookie-banner', CookieConsentSettings::class)->name('cookie-banner');
