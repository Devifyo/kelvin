<div class="wps-root">
    ...
    <div class="wps-panel">
        ...
        <div class="wps-tabs">
            ...
            <button type="button" wire:click="setTab('services')" class="wps-tab {{ $tab === 'services' ? 'active' : '' }}">
        ...
        <form wire:submit="save" class="wps-form">
            <div class="wps-form-body">
                ...
                <!-- ─── SERVICES / "WHAT WE OFFER" TAB ───────── -->
                @if($tab === 'services')
                <div wire:key="tab-services">
                    <div class="wps-section-label">"What We Offer" Section</div>

                    <div class="wps-field">
                        <label class="wps-label">Kicker Title</label>
                        <input type="text" wire:model.live.debounce.500ms="offer_kicker" class="wps-input" placeholder="What We Offer">
                    </div>

                    <div class="wps-grid-2">
                        <div class="wps-field">
                            <label class="wps-label">Heading (Regular)</label>
                            <input type="text" wire:model.live.debounce.500ms="offer_title" class="wps-input" placeholder="Consulting &amp;">
                        </div>
                        <div class="wps-field">
                            <label class="wps-label">Heading (Italic)</label>
                            <input type="text" wire:model.live.debounce.500ms="offer_title_em" class="wps-input" placeholder="Training Services">
                        </div>
                    </div>

                    <div class="wps-field" style="margin-bottom: 0;">
                        <label class="wps-label">Description</label>
                        <textarea wire:model.live.debounce.500ms="offer_body" class="wps-input" style="min-height: 120px;" placeholder="We offer a variety of consulting and training services..."></textarea>
                        <div class="wps-hint">Intro paragraph shown above the Consulting &amp; Training service lists.</div>
                    </div>
                </div>
                @endif
                ...
                <section id="principal" style="background: var(--white); padding: 8rem 4.5rem;">
                    <div class="principal-wrap">
                        ...
                        <div class="reveal in" style="opacity:1; transform:none;">
                            <div class="kicker">{{ $offer_kicker ?: 'What We Offer' }}</div>
                            <h2 class="section-h">{{ $offer_title ?: 'Consulting &' }} <em>{{ $offer_title_em ?: 'Training Services' }}</em></h2>
                            <div class="ornament"></div>
                            <p class="svc-desc">{{ $offer_body ?: 'We offer a variety of consulting and training services. We can work with all levels at a client, from the hands-on engineers to the C-suite.' }}</p>
                            <div class="svc-group">
