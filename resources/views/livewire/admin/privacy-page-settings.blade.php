<div class="lps-root">
    ...
    <div class="lps-panel">
        ...
        <div class="lps-panel-header">
            ...
            <div>
                <div class="lps-panel-title">Privacy Policy Page</div>
                <div class="lps-panel-subtitle">Header, rich-text body & SEO for /privacy-policy</div>
            </div>
        </div>
            ...
            <div class="lps-form-body">
                ...
                <div wire:key="lps-tab-header">
                    ...
                    <div class="lps-grid-2">
                        <div class="lps-field">
                            ...
                            <input type="text" wire:model="header_h1_regular" class="lps-input" placeholder="Privacy">
                        </div>
                        <div class="lps-field">
                            <label class="lps-label">H1 Italic</label>
                            <input type="text" wire:model="header_h1_em" class="lps-input" placeholder="Policy">
                        </div>
                    </div>
                ...
                <div wire:key="lps-tab-content">
                    ...
                    <div class="lps-field lps-editor-wrap">
                        <label class="lps-label">Privacy Policy Content (Rich Text)</label>
                        <div wire:ignore>
                        ...
                        <div class="lps-hint">Use headings (H2 / H3), lists, links and tables to structure the policy. Images are uploaded automatically.</div>
                    </div>
                </div>
                @endif
                ...
                <div wire:key="lps-tab-seo">
                    ...
                    <div class="lps-field">
                        ...
                        <input type="text" wire:model="seo_title" class="lps-input" placeholder="Privacy Policy | Kevin Thompson Ph.D.">
                        <div class="lps-hint">50–60 characters recommended.</div>
                    </div>

                    <div class="lps-field">
                        <label class="lps-label">Meta Description</label>
                        <textarea wire:model="seo_description" class="lps-input" placeholder="A brief description of how visitor data is handled..."></textarea>
                        <div class="lps-hint">120–160 characters recommended.</div>
                    </div>

                    <div class="lps-field">
                        <label class="lps-label">Meta Keywords</label>
                        <input type="text" wire:model="seo_keywords" class="lps-input" placeholder="privacy policy, gdpr, data protection">
                    </div>
                </div>
                @endif
