<aside class="admin-sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav" id="sidebar-nav">
        ...
        <a href="{{ route('admin.contact-page') }}" class="nav-item {{ request()->routeIs('admin.contact-page') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.privacy-page') }}" class="nav-item {{ request()->routeIs('admin.privacy-page') ? 'active' : '' }}">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
            Privacy Policy
        </a>

        <a href="{{ route('admin.terms-page') }}" class="nav-item {{ request()->routeIs('admin.terms-page') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.podcasts-webinars') }}" class="nav-item {{ request()->routeIs('admin.podcasts-webinars') ? 'active' : '' }}">
