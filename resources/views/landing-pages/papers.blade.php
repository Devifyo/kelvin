...
<section class="content-section">
    <div class="papers-grid" id="papers-container">
        ...
        <div class="paper-card" data-category="case-studies">
            ...
            <h2 class="paper-title">Eleven Lessons Learned about Agile Hardware Development<span style="display:none;">[cite: 59]</span></h3>
        ...
        <div class="paper-card" data-category="case-studies">
            ...
            <h2 class="paper-title">AgileVox Scrum for Hardware<span style="display:none;">[cite: 63]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="case-studies">
            ...
            <h2 class="paper-title">Plantronics Case Study<span style="display:none;">[cite: 67]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="case-studies">
            ...
            <h2 class="paper-title">Bird Technologies Case Study<span style="display:none;">[cite: 71]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="case-studies">
            ...
            <h2 class="paper-title">A Real Release-Planning Experience<span style="display:none;">[cite: 75]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="case-studies">
            ...
            <h2 class="paper-title">Agilent Case Study<span style="display:none;">[cite: 79]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="white-papers">
            ...
            <h2 class="paper-title">Agile Processes for Hardware Development<span style="display:none;">[cite: 83]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="white-papers">
            ...
            <h2 class="paper-title">Agile Development for Medical Products<span style="display:none;">[cite: 87]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="white-papers">
            ...
            <h2 class="paper-title">The Price of Uncertainty<span style="display:none;">[cite: 92]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="white-papers">
            ...
            <h2 class="paper-title">The Agile PMO<span style="display:none;">[cite: 97]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="white-papers">
            ...
            <h2 class="paper-title">Recipes for Agile Governance in the Enterprise (RAGE)<span style="display:none;">[cite: 102]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="white-papers">
            ...
            <h2 class="paper-title">Agile, Scrum, and “Hitting the Date”<span style="display:none;">[cite: 106]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="presentations">
            ...
            <h2 class="paper-title">The Agile Hardware Research Project<span style="display:none;">[cite: 111]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="presentations">
            ...
            <h2 class="paper-title">Agile for Hardware: A Briefing to Gartner, Inc.<span style="display:none;">[cite: 114]</span></h3>
            <div class="paper-desc">
        ...
        <div class="paper-card" data-category="presentations">
            ...
            <h2 class="paper-title">Scrum for Hardware Conference Keynote<span style="display:none;">[cite: 118]</span></h3>
            <div class="paper-desc">
