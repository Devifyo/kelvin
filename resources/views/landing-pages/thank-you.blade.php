...
@push('styles')
<style>
    .ty-section { min-height: 68vh; display:flex; align-items:center; justify-content:center; background:var(--slate); padding:9rem 1.5rem 6rem; text-align:center; position:relative; overflow:hidden; }
